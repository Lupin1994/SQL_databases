...
*/
CREATE view Cars_price_before_25000 as 
select *
from cars
where cost < 25000;
select * from cars_price_before_25000;
...
*/
Alter view cars_price_before_25000 as
	SELECT *
    from cars
    where cost < 30000;
select * from cars_price_before_25000;
...
SELECT 
	trains.*,
	TIMEDIFF (LEAD(station_time) OVER (PARTITION BY train_id), station_time) AS time_to_next_station_interval
FROM trains;